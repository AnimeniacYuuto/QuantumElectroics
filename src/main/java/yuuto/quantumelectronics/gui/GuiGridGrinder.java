...
import yuuto.quantumelectronics.gui.container.ContainerGridGrinder;
...
public class GuiGridGrinder extends GuiEnergyHandler{

	static ResourceLocation texture = new ResourceLocation(References.MOD_ID.toLowerCase(), "textures/gui/gridMachine.png");
	TileGridGrinder tile;
	public GuiGridGrinder(TileGridGrinder tile, EntityPlayer player) {
		super(new ContainerGridGrinder(tile, player));
		this.tile = tile;
		this.xSize = 176;
		this.ySize = 166;
	}
