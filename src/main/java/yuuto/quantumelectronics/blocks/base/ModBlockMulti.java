...
public class ModBlockMulti extends ModBlock{
	...
	@SideOnly(Side.CLIENT)
	/**
	 * gets the texture name of the block for the given metadata
	 * @param metaData
	 * @return
	 */
	...
	/**
	 * gets an array of unlocalized names for the sub-blocks
	 * @return an array of unlocalized names for the sub-blocks
	 */
